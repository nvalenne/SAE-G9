  ...
  <div class="app">
    <div class="manege">
      ...
      <v-card elevation="8" style="padding: 60px;border-radius: 30px;">
        <v-card-title>Formulaire pour la création de manège</v-card-title>
        <v-card-text>
          Afin d'incrire votre manège aux Papiots vous devez remplirer le formulaire ci-dessous.
...
export default {
  ...
  methods:{
    submitForm(){
      ...
      axios.put('http://localhost:3000/attractions/incription', this.form)
          .then((reponse) => {
            console.log(reponse);
